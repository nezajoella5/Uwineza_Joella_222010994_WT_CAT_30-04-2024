...
<body style="background-image: url('./images/shop.jpeg');background-repeat: no-repeat;background-size: cover;">

<div class="overlay">
  <div class="container">
    <h1 style="color: black;">WELCOME TO ONLINE CUSTOMER FEEDBACK</h1>
