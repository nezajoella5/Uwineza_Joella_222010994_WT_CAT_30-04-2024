...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO products(productid, productname,price) VALUES (?, ?, ?)");
    $stmt->bind_param("sss", $pid, $pname, $pr);
    ...
    <table border="5">
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                $pid = $row['productid']; // Fetch the productid
                echo "<tr>
                    <td>" . $row['productid'] . "</td>
                    <td>" . $row['productname'] . "</td>
                    <td>" . $row['price'] . "</td>
                    <td><a style='padding:4px' href='delete_products.php?productid=$pid'>Delete</a></td> 
                    <td><a style='padding:4px' href='update_products.php?productid=$pid'>Update</a></td> 
                </tr>";
            }
        } else {
